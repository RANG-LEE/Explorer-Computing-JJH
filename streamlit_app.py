...
def page_keyword_analysis():
    ...
    st.markdown("Google Trend 데이터를 레이더로 활용하여 **소비자 관심도 신호**를 포착합니다.")
    ...
    trend_insights = {
        ...
        "Protein": "💪 **Protein (단백질)**: 5년 내내 가장 높은 베이스라인(기본 관심도)을 유지하는 강력한 키워드입니다. 헬시플레저(Healthy Pleasure) 트렌드와 맞물려 필수 영양소로서의 위상이 견고합니다.",
        "Vegan": "🌿 **Vegan (비건)**: 초기 급상승 이후 현재는 안정화 단계에 접어들었습니다. 단순한 호기심을 넘어 하나의 확고한 식문화 장르로 정착하며 고정적인 마니아층 검색량을 확보하고 있습니다.",
        "Slow Aging": "🐢 **Slow Aging (저속노화)**: 최근 새롭게 등장한 이머징(Emerging) 키워드입니다. 2023년 말부터 검색량이 폭발적으로 증가하기 시작했으며, '가속 노화'를 막으려는 2030 세대의 높은 관심을 대변합니다."
    }
